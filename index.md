...
`ibmsmooth` fits global and locally adaptive integrated Brownian motion
smoothers for Gaussian observations using either a Stan backend or an
INLA backend.
...
[LICENSE](https://jessalynnsebastian.github.io/ibmsmooth/LICENSE) for
details.
